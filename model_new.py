...
def subpixel_restack(input_tensor, n_prime, m_prime=None, name=None):
    n = input_tensor.get_shape().as_list()[1]
    m = input_tensor.get_shape().as_list()[2]
    r_n = n_prime - n
    if m_prime is None:
        for i in range(1, m):
            r_m = i
...
def audio_u_net_dnn(input_type,
    ...
    with tf.name_scope(scope_name):
        ...
        d1 = downsampling_d1_batch_norm_act(
            ...
            num_filters=channel_multiple * num_of_channels,
        ...
        y = subpixel_reshuffling_1d(conv,
                                    num_of_channels)
